...
![Ammo Fabricator](images/comp_ammo_fabricator.png)
...
|--------|-----|---------------|-----------------|
| [Build Ammo Fabricator](craft_ammo_fabricator.md) | 1 | 12 ticks | Engineering 2, Weapon Crafting 3 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| [Build Crimson Ordnance Bay](craft_crimson_ordnance_bay.md) | 1 | [Crimson Ordnance Bay](comp_crimson_ordnance_bay.md) |
