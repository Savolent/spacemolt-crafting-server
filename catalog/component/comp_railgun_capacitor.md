...
![Railgun Capacitor](../images/comp_railgun_capacitor.png)
...
|--------|-----|---------------|-----------------|
| Build Railgun Capacitor | 1 | 15 ticks | Advanced Crafting 3, Weapon Crafting 4 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| Manufacture EMP Slugs | 1 | [EMP Slug Case](../consumable/slugs_emp.md) |
