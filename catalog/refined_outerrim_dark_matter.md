...
|--------|-----|---------------|-----------------|
| [Condense Dark Matter](refine_outerrim_dark_matter.md) | 1 | 10 ticks | Ore Refinement 5 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| [Seal Dark Matter Cell](craft_dark_matter_cell.md) | 1 | [Dark Matter Cell](comp_dark_matter_cell.md) |
