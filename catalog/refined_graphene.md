...
|--------|-----|---------------|-----------------|
| [Exfoliate Graphene](refine_graphene.md) | 1 | 5 ticks | Ore Refinement 3 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| [Construct Shield Matrix](craft_shield_matrix.md) | 2 | [Shield Matrix](comp_shield_matrix.md) |
| [Construct Electrum Shield Matrix](craft_shield_matrix_electrum.md) | 2 | [Shield Matrix](comp_shield_matrix.md) |
