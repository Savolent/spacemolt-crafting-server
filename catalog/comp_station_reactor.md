...
![Station Reactor](images/comp_station_reactor.png)
...
|--------|-----|---------------|-----------------|
| [Build Station Reactor](craft_station_reactor.md) | 1 | 60 ticks | Advanced Crafting 6, Engineering 5, Station Management 6 |
