...
![Voidborn Null Matrix](images/comp_voidborn_null_matrix.png)
...
|--------|-----|---------------|-----------------|
| [Build Voidborn Null Matrix](craft_voidborn_null_matrix.md) | 1 | 15 ticks | Engineering 4, Shield Crafting 5 |
