...
![Wiring Harness](images/comp_wiring_harness.png)
...
|--------|-----|---------------|-----------------|
| [Build Wiring Harness](craft_wiring_harness.md) | 3 | 4 ticks | Basic Crafting 2 |
| [Strip Wiring from Components](salvage_to_wiring.md) | 1 | 3 ticks | Salvaging 2 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| [Build Power Distribution Grid](craft_power_grid.md) | 5 | [Power Distribution Grid](comp_power_grid.md) |
