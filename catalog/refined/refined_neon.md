...
|--------|-----|---------------|-----------------|
| Ionize Neon Gas | 3 | 3 ticks | Gas Processing 1 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| Build Neon Signaling Array | 3 | [Neon Signaling Array](../component/comp_neon_signaling_array.md) |
| Build Sensor Booster | 2 | [Sensor Booster](../consumable/sensor_booster.md) |
