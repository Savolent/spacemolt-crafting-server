...
|--------|-----|---------------|-----------------|
| Synthesize Neural Gel | 1 | 5 ticks | Advanced Crafting 2 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| Manufacture Neural EM Charges | 1 | [Neural Disruption Charge Pack](../consumable/em_neural.md) |
| Culture Repair Nanites | 2 | [Repair Nanite Container](../component/comp_repair_nanites.md) |
