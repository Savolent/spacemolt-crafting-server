...
|--------|-----|---------------|-----------------|
| Concentrate Ion Gas | 2 | 8 ticks | Gas Processing 7, Ore Refinement 4 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| Synthesize Afterburner Fuel | 1 | [Afterburner Fuel](../consumable/afterburner_fuel.md) |
| Build Ion Emitter (Gas Method) | 3 | [Ion Emitter](../component/comp_ion_emitter.md) |
| Build Ion Thruster | 2 | [Thruster Nozzle](../component/comp_thruster_nozzle.md) |
