...
|--------|-----|---------------|-----------------|
| Sinter Silicate Composite | 1 | 4 ticks | Ore Refinement 2 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| Culture Repair Nanites | 1 | [Repair Nanite Container](../component/comp_repair_nanites.md) |
| Manufacture Frag Rounds | 1 | [Fragmentation Rounds Box](../consumable/rounds_fragmenting.md) |
| Construct Shield Matrix | 1 | [Shield Matrix](../component/comp_shield_matrix.md) |
| Construct Electrum Shield Matrix | 1 | [Shield Matrix](../component/comp_shield_matrix.md) |
