...
|--------|-----|---------------|-----------------|
| Assemble Power Battery | 1 | 4 ticks | Ore Refinement 2 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| Assemble Power Core | 1 | [Power Core](../component/power_core.md) |
| Build Weapon Core | 1 | [Weapon Core](../component/comp_weapon_core.md) |
