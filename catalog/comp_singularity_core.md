...
![Singularity Core](images/comp_singularity_core.png)
...
|--------|-----|---------------|-----------------|
| [Build Singularity Core](craft_singularity_core.md) | 1 | 120 ticks | Advanced Crafting 9, Engineering 8, Radioactive Handling 7 |
