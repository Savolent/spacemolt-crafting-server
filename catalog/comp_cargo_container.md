...
![Cargo Container](images/comp_cargo_container.png)
...
|--------|-----|---------------|-----------------|
| [Build Cargo Container](craft_cargo_container.md) | 1 | 5 ticks | Basic Crafting 2 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| [Build Cargo Superstructure](craft_cargo_superstructure.md) | 2 | [Cargo Superstructure](comp_cargo_superstructure.md) |
| [Build Nebula Cargo Matrix](craft_nebula_cargo_matrix.md) | 2 | [Nebula Cargo Matrix](comp_nebula_cargo_matrix.md) |
