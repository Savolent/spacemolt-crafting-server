...
![Thruster Nozzle](images/comp_thruster_nozzle.png)
...
|--------|-----|---------------|-----------------|
| [Build Ion Thruster](craft_ion_thruster.md) | 2 | 12 ticks | Advanced Crafting 3, Gas Processing 7 |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| [Build Dark Matter Thruster](craft_outerrim_dark_thruster.md) | 3 | [Dark Matter Thruster](comp_outerrim_dark_thruster.md) |
| [Build Thruster Assembly](craft_thruster_assembly.md) | 3 | [Thruster Assembly](comp_thruster_assembly.md) |
