...
![Weapon Housing](images/comp_weapon_housing.png)
...
|--------|-----|---------------|-----------------|
| [Fabricate Weapon Housing](craft_weapon_housing.md) | 1 | 6 ticks | None |

### Used In

| Recipe | Qty | Produces |
|--------|-----|----------|
| [Build Defense Platform](craft_defense_platform.md) | 2 | [Defense Platform](comp_defense_platform.md) |
| [Build Weapon Battery](craft_weapon_battery.md) | 2 | [Weapon Battery](comp_weapon_battery.md) |
