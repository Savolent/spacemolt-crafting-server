...
|----------|------:|-------------|
| [artifact](artifact/) | 15 | Rare relics and ancient objects from lost civilizations. |
...
| [ore](ore/) | 84 | Raw ores, gases, ice, and biological samples harvested from space. |
| [refined](refined/) | 77 | Processed materials refined from raw ores and gases. |
| [weapon](weapon/) | 1 | Weapons and weapon systems. |
