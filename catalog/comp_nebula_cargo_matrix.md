...
![Nebula Cargo Matrix](images/comp_nebula_cargo_matrix.png)
...
|--------|-----|---------------|-----------------|
| [Build Nebula Cargo Matrix](craft_nebula_cargo_matrix.md) | 1 | 8 ticks | Basic Crafting 4, Engineering 2 |
