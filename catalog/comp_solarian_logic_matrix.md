...
![Solarian Logic Matrix](images/comp_solarian_logic_matrix.png)
...
|--------|-----|---------------|-----------------|
| [Build Solarian Logic Matrix](craft_solarian_logic_matrix.md) | 1 | 12 ticks | Basic Crafting 4, Engineering 5 |
